...
class shop:
	def __init__(self,master):
		self.master=master
		master.title("SKIN SHOP")
		screen = Canvas(master, width=750, height=400, background="cyan")
		screen.pack()
		#khung
		...
		btn_buy1 = Button(master, text='Buy',width=10, height=2,command=partial(command1,2000))
		btn_buy1.place(x=600,y=105)
		btn_buy2 = Button(master, text='Buy',width=10, height=2,command=partial(command2,2500))
		btn_buy2.place(x=600,y=170)
		btn_buy3 = Button(master, text='Buy',width=10, height=2,command=partial(command3,3000))
		btn_buy3.place(x=600,y=235)
		btn_buy4 = Button(master, text='Buy',width=10, height=2,command=partial(command4,3500))
		btn_buy4.place(x=600,y=300)
		btn_exit = Button(master, text='BACK',width=10, height=1,command=close)
