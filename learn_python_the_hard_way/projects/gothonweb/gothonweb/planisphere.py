...
class Room(object):
    ...
    def __init__(self, name, description):     # khởi tạo truyền vào 2 chuỗi là name (loại phòng) và description
        self.name = name
    ...
    def add_paths(self, paths):            # thêm các dict
        self.paths.update(paths)
        
central_corridor = Room("Central Corridor", # Tên biến các phòng
"""
